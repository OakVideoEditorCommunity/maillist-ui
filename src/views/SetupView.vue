...
const form = reactive({
  ...
  server: {
    ...
    aiAccessKeyId: '',
    aiAccessKeySecret: '',
    aiRegion: 'cn-shanghai',
    aiEndpoint: 'https://green-cip.cn-shanghai.aliyuncs.com',
  },
  admin: {
    email: '',
    name: '',
...
const handleSubmit = async () => {
  ...
  try {
    await setupApi.setup({
      ...
      ai_enabled: form.server.aiEnabled || undefined,
      ai_provider: form.server.aiProvider || undefined,
      ai_access_key_id: form.server.aiAccessKeyId || undefined,
      ai_access_key_secret: form.server.aiAccessKeySecret || undefined,
      ai_region: form.server.aiRegion || undefined,
      ai_endpoint: form.server.aiEndpoint || undefined,
